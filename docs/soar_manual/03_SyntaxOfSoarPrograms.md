...
[the Soar architecture](./02_TheSoarArchitecture.md).

## Working Memory

Working memory contains working memory elements (WME’s). As described in [Chapter 2](./02_TheSoarArchitecture.md),
...
[`print` command](./../CLI/cmd_print.md). But internally, they are actually
uppercase letters.)
...
See [wm command](./../CLI/cmd_wm.md) for working memory settings and options for
enabling WMA.
...
command, described in the [print command](./../CLI/cmd_print.md).
...
is printed using the [`print` command](./../CLI/cmd_print.md).
...
capabilities. For more information, see [`sp` command](./../CLI/cmd_sp.md).
...
[`print` command](./../CLI/cmd_print.md)), the production will not be
...
[`preferences` command](./../CLI/cmd_preferences.md)).
...
useful for debugging. See ['sp' command](./../CLI/cmd_sp.md) for more information.
...
['output` command](./../CLI/cmd_output.md#general-output-settings) for
...
settings for the [`chunk` command](./../CLI/cmd_chunk.md). Using the `chunk`
